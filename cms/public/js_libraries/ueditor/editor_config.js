...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:"/index.php?m=admin&c=attachment&a=ueditor&module=news"  //图片上传提交地址
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
		...
		"insertunorderedlist","insertorderedlist","justifyleft","justifycenter","justifyright","justifyjustify","|",
		"insertimage","emotion","insertvideo","attachment","|",
		"unlink","link","cleardoc","selectall","print","searchreplace","preview","pagebreak","|",
		"date","time","spechars","blockquote","highlightcode","|",
		"background","template","separate","touppercase","tolowercase","directionalityltr","directionalityrtl",
		"removeformat","formatmatch","autotypeset","pasteplain","indent",
		"rowspacingbottom","rowspacingtop","lineheight","imagenone","imageleft","imageright","imagecenter","|",
