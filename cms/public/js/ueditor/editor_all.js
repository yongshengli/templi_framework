...
(function () {
    ...
    var Editor = UE.Editor = function ( options ) {
        ...
        me.setOpt( {
			...
			thirdpartyPath:me.options.UEDITOR_HOME_URL + 'third-party/',
...
//            }
    ...
    UE.plugins['source'] = function (){
        ...
        if(opt.sourceEditor == "codemirror"){
            ...
            me.addListener("ready",function(){
                utils.loadFile(document,{
                    src : opt.codeMirrorJsUrl || me.options.thirdpartyPath + "codemirror/codemirror.js",
                    tag : "script",
                    type : "text/javascript",
                    defer : "defer"
                },function(){
                ...
                utils.loadFile(document,{
                    ...
                    rel : "stylesheet",
                    type : "text/css",
                    href : opt.codeMirrorCssUrl || me.options.thirdpartyPath + "codemirror/codemirror.css"
                });
...
UE.commands['preview'] = {
    execCommand : function(){
        var w = window.open('', '_blank', ''),
            d = w.document;
        d.open();
        d.write('<html><head><script src="'+this.options.thirdpartyPath+'uparse.js"></script><script>' +
            "setTimeout(function(){uParse('div',{" +
            "    'highlightJsUrl':'"+this.options.thirdpartyPath+"SyntaxHighlighter/shCore.js'," +
                "    'highlightCssUrl':'"+this.options.thirdpartyPath+"SyntaxHighlighter/shCoreDefault.css'" +
                "})},300)" +
    ...
    me.addListener("ready",function(){
        ...
        if(typeof me.XRegExp == "undefined"){
            utils.loadFile(me.document,{
                ...
                src : me.options.highlightJsUrl || me.options.thirdpartyPath + "SyntaxHighlighter/shCore.js",
                tag : "script",
                type : "text/javascript",
                defer : "defer"
            },function(){
        ...
        if(!me.document.getElementById("syntaxhighlighter_css")){
            utils.loadFile(me.document,{
                ...
                rel : "stylesheet",
                type : "text/css",
                href : me.options.highlightCssUrl ||me.options.thirdpartyPath + "SyntaxHighlighter/shCoreDefault.css"
            });
        }
