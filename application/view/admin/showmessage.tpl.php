    ...
    <div class="main">
        ...
        <div class="link">
            ...
            <?php elseif($url_forward):?>
                如果浏览器没有自动跳转,点击[<a href="<?=$url_forward?>">这里</a>]
                <script type="text/javascript">setTimeout("redirect('<?=$url_forward?>');",<?=$ms?>);</script>
            <?endif?>
            <a href="<?=APP_URL?>index.php?m=admin&c=index">[后台首页]</a>
        </div>
    </div>
</div>
